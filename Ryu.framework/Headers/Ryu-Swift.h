...
SWIFT_CLASS("_TtC3Ryu16FoundationStream")
...
SWIFT_CLASS("_TtC3Ryu15KeychainManager")
...
///
/// \endcode
SWIFT_CLASS("_TtC3Ryu13OnAckCallback")
...
@interface RDCTimedGame : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC3Ryu16RDCTurnBasedGame")
@interface RDCTurnBasedGame : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC3Ryu17RDCViewController")
@interface RDCViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC3Ryu11SSLSecurity")
...
SWIFT_CLASS("_TtC3Ryu16SocketAckEmitter")
...
SWIFT_CLASS("_TtC3Ryu14SocketAnyEvent")
...
SWIFT_CLASS("_TtC3Ryu12SocketEngine")
...
SWIFT_PROTOCOL("_TtP3Ryu18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_PROTOCOL("_TtP3Ryu16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC3Ryu14SocketIOClient")
...
SWIFT_PROTOCOL("_TtP3Ryu17SocketManagerSpec_")
...
SWIFT_CLASS("_TtC3Ryu13SocketManager")
...
///
/// \endcode
SWIFT_CLASS("_TtC3Ryu16SocketRawAckView")
...
///
/// \endcode
SWIFT_CLASS("_TtC3Ryu13SocketRawView")
